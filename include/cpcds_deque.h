...
#define define_cpcds_deque(name,__t__)define_cpcds_dqmk(name,__t__)define_cpcds_dqappend(name,__t__)define_cpcds_dqalias(name,__t__)typedef cpcds_deque_##name*cpcds_deque_##name##ptr;
