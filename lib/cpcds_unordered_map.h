...
#define define_cpcds_um(name,__k__,__v__,efunc,hfunc)define_cpcds_umk(name,__k__,__v__,efunc,hfunc)define_cpcds_uiter(name,__k__,__v__)typedef cpcds_um_##name*cpcds_um_##name##ptr;
