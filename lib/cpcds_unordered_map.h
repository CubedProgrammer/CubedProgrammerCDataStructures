...
#define define_cpcds_um(name,__k__,__v__)define_cpcds_umk(name,__k__,__v__)
#define cpcds_um_define(__k__,__v__)define_cpcds_um(__k__##__##__v__,__k__,__v__)
#endif
#endif
